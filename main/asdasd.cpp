...
private:
    ...
    int InitVulkan()
    {
        ...
        debugCreateInfo.pfnUserCallback = MyDebugCallback;
        // 为了windows平台添加的窗口?
        ...
        std::cout << "validation " << CheckValidationLayerSupport() << std::endl;
