...
private:
    ...
    void createGraphicsPipeline()
    {
        ...
        colorBlendAttachment.blendEnable = VK_TRUE; // 一定要开启混合

        colorBlendAttachment.srcColorBlendFactor = VK_BLEND_FACTOR_SRC_ALPHA;           // 源颜色乘以源alpha
        colorBlendAttachment.dstColorBlendFactor = VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA; // 目标颜色乘以（1 - 源alpha）
        colorBlendAttachment.colorBlendOp = VK_BLEND_OP_ADD;                            // 相加

        colorBlendAttachment.srcAlphaBlendFactor = VK_BLEND_FACTOR_ONE; // alpha直接覆盖
