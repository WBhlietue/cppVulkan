...
void VKTextureManager::LoadTexture(const std::string& path) {
    ...
    // VkImageView imageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB);
...
void VKTextureManager::transitionImageLayout(
...
void VKTextureManager::createBuffer(
...
uint32_t VKTextureManager::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
{
